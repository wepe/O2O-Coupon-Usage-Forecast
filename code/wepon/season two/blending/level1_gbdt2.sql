drop table if exists wepon_level1_gbdt2_d2_pred;
drop table if exists wepon_level1_gbdt2_d3_pred;
DROP OFFLINEMODEL IF EXISTS wepon_level1_gbdt2;
...
-DmodelName="wepon_level1_gbdt2"  --����ģ��
-DmetricType="2"
...
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_gbdt2_d2_pred" --������
...
-DresultColName="prediction_result"
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_gbdt2_d3_pred" --������
-DscoreColName="prediction_score"
-DkvDelimiter=":"
