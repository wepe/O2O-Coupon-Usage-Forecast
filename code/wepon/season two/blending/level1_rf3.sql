drop table if exists wepon_level1_rf3_d2_pred;
drop table if exists wepon_level1_rf3_d3_pred;
DROP OFFLINEMODEL IF EXISTS wepon_level1_rf3;
...
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf3_d2_pred" --������
...
-DresultColName="prediction_result"
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf3_d3_pred" --������
-DscoreColName="prediction_score"
-DkvDelimiter=":"
