drop table if exists wepon_level1_rf2_d2_pred;
drop table if exists wepon_level1_rf2_d3_pred;
DROP OFFLINEMODEL IF EXISTS wepon_level1_rf2;
...
-DtreeNum="799"
-DalgorithmTypes="0,799"
-DrandomColNum="38"
-DminNumObj="400"
-DmaxTreeDeep="7"
-DmaxRecordSize="650000";
...
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf2_d2_pred" --������
...
-DresultColName="prediction_result"
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf2_d3_pred" --������
-DscoreColName="prediction_score"
-DkvDelimiter=":"
