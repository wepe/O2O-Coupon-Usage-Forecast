drop table if exists wepon_level1_rf1_d2_pred;
drop table if exists wepon_level1_rf1_d3_pred;
DROP OFFLINEMODEL IF EXISTS wepon_level1_rf1;
...
-DtreeNum="800"
-DalgorithmTypes="0,800"
-DrandomColNum="35"
-DminNumObj="300"
-DmaxTreeDeep="7"
-DmaxRecordSize="600000";
...
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf1_d2_pred" --������
...
-DresultColName="prediction_result"
-Dlifecycle="28" 
-DoutputTableName="wepon_level1_rf1_d3_pred" --������
-DscoreColName="prediction_score"
-DkvDelimiter=":"
