...
case when prediction_result=0 then 1.0-prediction_score else prediction_score end as probability from charles_gbdt_eval;
...
-- 1232761,28849,1203912,17134,1142494,11715,61418

drop table if exists charles_gbdt_submission_1;
create table charles_gbdt_submission_1 as 
