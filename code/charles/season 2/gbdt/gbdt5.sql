...
case when prediction_result=0 then 1.0-prediction_score else prediction_score end as probability from charles_gbdt_eval_4;
...
-- 1232761,36157,1196604,21340,1139392,14817,57212

drop table if exists charles_gbdt_submission_5;
create table charles_gbdt_submission_5 as 
