...
DROP OFFLINEMODEL IF EXISTS charles_xgboost_9;
...
create table charles_xgb_final_eval as 
	...
	(
		select user_id,coupon_id,date_received,label,
...
drop table if exists charles_xgb_submission_9;
create table charles_xgb_submission_9 as 
