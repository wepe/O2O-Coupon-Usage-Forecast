-- 验证集	0.7073485094916819  
-- 测试集	0.73083852
drop table if exists charles_xgb_train;
create table charles_xgb_train as select * from charles_df1_fillna;

drop table if exists charles_xgb_val;
create table charles_xgb_val as select * from charles_df2_fillna;

drop table if exists charles_xgb_test;
create table charles_xgb_test as select * from charles_df3_fillna;

select count(*) from charles_xgb_train; -- 1318767
select count(*) from charles_xgb_val; -- 2497536
select count(*) from charles_xgb_test; -- 1126092

drop table if exists charles_xgb_val_pred;
drop table if exists charles_xgb_test_pred;
DROP OFFLINEMODEL IF EXISTS charles_xgboost_2;
...
-- 2339793,117905,2221888,51991,2067042,65914,154846
...
drop table if exists charles_xgb_submission;
create table charles_xgb_submission as 
