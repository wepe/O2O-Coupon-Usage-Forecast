-- 验证集 0.6585144207112631
-- 测试集 
-- features extract bug fix & all features training
...
DROP OFFLINEMODEL IF EXISTS charles_xgboost_8;
...
drop table if exists charles_xgb_submission_8;
create table charles_xgb_submission_8 as 
...
select * from charles_xgb_eval_view;
-- counts,pred_1_counts,pred_0_counts,tp_counts,tn_counts,fp_counts,fn_counts
-- 1232761,39151,1193610,22348,1137406,16803,56204
