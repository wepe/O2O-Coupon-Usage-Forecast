...
DROP OFFLINEMODEL IF EXISTS charles_xgboost_5;
...
-DmodelName="charles_xgboost_5"  --输出模型
-Dgamma="0"
-Dlambda="10" 
...
-- 2339793,95358,2244435,44648,2082246,50710,162189
...
drop table if exists charles_xgb_submission_5;
create table charles_xgb_submission_5 as 
