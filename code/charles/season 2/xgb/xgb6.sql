...
select count(*) from charles_xgb_train; -- 2388842
select count(*) from charles_xgb_val; -- 1262855
select count(*) from charles_xgb_test; -- 1051258

drop table if exists charles_xgb_val_pred;
drop table if exists charles_xgb_test_pred;
DROP OFFLINEMODEL IF EXISTS charles_xgboost_6;
...
-DmodelName="charles_xgboost_6"  --输出模型
-Dgamma="0"
-Dlambda="10" 
...
-- 1232761,42083,1190678,21799,1133925,20284,56753
...
drop table if exists charles_xgb_submission_6;
create table charles_xgb_submission_6 as 
