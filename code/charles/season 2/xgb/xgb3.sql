...
DROP OFFLINEMODEL IF EXISTS charles_xgboost_3;
...
-DmodelName="charles_xgboost_3"  --输出模型
-Dgamma="0"
-Dlambda="10" 
...
-- 1232761,38432,1194329,20384,1136161,18048,58168
...
drop table if exists charles_xgb_submission_3;
create table charles_xgb_submission_3 as 
