...
select count(*) from charles_xgb_train; -- 2497536
select count(*) from charles_xgb_val; -- 1318767
...
DROP OFFLINEMODEL IF EXISTS charles_xgboost_4;
...
-DmodelName="charles_xgboost_4"  --输出模型
-Dgamma="0"
-Dlambda="10" 
...
-- 1232761,44623,1188138,22698,1132284,21925,55854
...
drop table if exists charles_xgb_submission_4;
create table charles_xgb_submission_4 as 
