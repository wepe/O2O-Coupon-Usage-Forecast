...
-- 取全集
create table if not exist charles_all_dataset as select * from prediction_stage2;
create table if not exist charles_all_feature as select * from train_offline_stage2 where date_received!="null";
create table if not exist charles_all_online_feature as select * from train_online_stage2;
